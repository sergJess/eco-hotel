...
<div class="mobile-menu">
    <div class="mobile-menu__body">
        ...
        <div class="mobile-menu__list">
            ...
            <a href="store" class="mobile-menu__item mobile-menu__menu-button_active">эко магазин</a>
    ...
    <div class="block__body">
        ...
        <div class="menu-block__bottom-slice">
            ...
            <div class="menu-block__menu-list">
                ...
                <a href="store" class="menu-block__menu-button menu-block__menu-button_active">эко магазин</a>
    ...
    <div class="block__body">
        ...
        <div class="store">
            <div class="store__item">
                <img class="store__item-image" src="http://eco-hotel.melon.su/wp-content/uploads/2022/08/venik.png">
