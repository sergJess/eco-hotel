...
<div class="mobile-menu">
    <div class="mobile-menu__body">
        ...
        <div class="mobile-menu__list">
            ...
            <a href="rooms" class="mobile-menu__item mobile-menu__menu-button_active">номера и цены</a>
    ...
    <div class="block__body">
        ...
        <div class="menu-block__bottom-slice">
            ...
            <div class="menu-block__menu-list">
                ...
                <a href="rooms" class="menu-block__menu-button menu-block__menu-button_active">номера и цены</a>
...
<div class="rooms-block block">
    <div class="block__body">
        <h1>Номера</h1>
        <p>К услугам гостей 4 комфортабельных домике с 10 просторными и светлыми комнатами</p>
        <a class="button" onclick="pupUp()">забронировать</a>
    </div>
</div>
<div class="rooms-list block">
    <div class="block__body">
        <div class="rooms-list__dual-section">
            <div class="rooms-list__dual-section-left">
                <div class="gallery">
                        ...
                        <div class="gallery__images swiper">
                            <div class="swiper-wrapper">
                                <div class="swiper-slide">
                                    <div class="gallery__images-item" style="background-image: url('http://eco-hotel.melon.su/wp-content/uploads/2022/08/2-4.png');"></div>
                                </div>
                                <div class="swiper-slide">
                                    <div class="gallery__images-item" style="background-image: url('http://eco-hotel.melon.su/wp-content/uploads/2022/08/1-4.png');"></div>
                                </div>
                                <div class="swiper-slide">
                                    <div class="gallery__images-item" style="background-image: url('http://eco-hotel.melon.su/wp-content/uploads/2022/08/2-4.png');"></div>
                                </div>
                    ...
                    <div class="gallery__bottom-slice">
                        <div class="gallery__mobile-left-button"></div>
                        <div class="gallery__points">
                            <div class="gallery__point"></div>
                            <div class="gallery__point"></div>
                            <div class="gallery__point"></div>
                        </div>
                        <div class="gallery__mobile-right-button"></div>
                    </div>
                </div>
                <div class="button button_white button_mobile" onclick="pupUp()">забронировать</div>
            </div>
            <div class="rooms-list__dual-section-right">
                <h2>Single Room</h2>
                <p>Большая кровать, зона отдыха с мягким креслом, письменный стол, ванная комната с душем.</p>
        ...
        <div class="rooms-list__dual-section">
            <div class="rooms-list__dual-section-left">
                ...
                <p>Большая кровать, зона отдыха с мягким креслом, письменный стол, ванная комната с душем.
                    <br><br>
                    Стоимость от 3500р./сутки</p>
                <div class="button button_white" onclick="pupUp()">забронировать</div>
            </div>
            <div class="rooms-list__dual-section-right">
                <div class="gallery">
